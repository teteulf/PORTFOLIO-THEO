...
export default function About() {
  ...
  return (
    <main className="flex w-full h-full items-center justify-center gap-12 ">
      <section className="flex flex-col">
        <h1 className="text-[60px] text-white font-bold">
          Captivating <strong className="text-red-600">stories</strong>.
        </h1>
        <p className="w-[550px] opacity-50 text-white text-[14px]">
        ...
        <div className="flex mt-20 items-center gap-6">
          <div className="flex flex-col justify-center border-r-[0.5px] border-gray-500 border-opacity-50 max-w-[130px] max-h-[110px] pr-10">
      ...
      <section className="flex flex-col items-start justify-center relative gap-8 min-w-[412px]">
        ...
        <a className="flex flex-start w-[400px] items-center text-[20px] text-gray-400 cursor-pointer hover:text-gray-600 group">
          Download my CV -{" "}
          <IoSchool
