  ...
  return (
    <main className="flex flex-col xl:flex-row w-full h-full items-center justify-center gap-12 ">
      <section className="flex flex-col items-center justify-center text-center xl:text-left">
        <h1 className=" text-[35px] xl:text-[60px] text-white font-bold">
          Captivating <strong className="text-red-600">stories</strong>.
        </h1>
        <p className="w-[80%] max-w-[550px] xl:max-w-[100%] xl:w-[550px] opacity-50 text-white text-[10px] xl:text-[14px]">
        ...
        <div className=" mt-10 xl:mt-20 items-center hidden xl:flex  xl:gap-6">
          <div className="flex flex-col justify-center border-r-[0.5px] border-gray-500 border-opacity-50 max-w-[130px] max-h-[110px] xl:pr-10">
          ...
          <div className="flex flex-col justify-center max-w-[130px] max-h-[110px]">
      ...
      <section className="flex flex-col items-center xl:items-start justify-center relative gap-8 min-w-[412px]">
          ...
          {aboutData.map((item, itemIndex) => (
            ...
            >
              ...
              <div
                className={`${
                  index === itemIndex &&
                  "bg-red-600 transition-all w-[100%] duration-500"
                } w-8 h-[2px] absolute bg-white bottom-0 left-0`}
              ></div>
            </div>
          ))}
        </div>
        <div className="flex text-white relative min-h-[150px] min-w-[300px] ">
          {aboutData[index].info}
        </div>
        <a className="flex xl:flex-start w-[400px] items-center justify-center text-[20px] text-gray-400 cursor-pointer hover:text-gray-600 group">
          Download my CV -{" "}
          <IoSchool
